...
export default function ProfileManagement() {
  return (
    <div className="p-6 p-4 shadow-inner border rounded">
      <div className="max-w-4xl p-6">
        <div className="flex items-center mb-6">
          ...
          <div className="ml-6">
            ...
            <p className="text-gray-500">Joined on January 20, 2023</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-6">
          ...
          <ul>
            ...
            <li className="flex items-center mb-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-300">
              <i className="fas fa-sign-out-alt text-xl text-red-600 mr-4"></i>
